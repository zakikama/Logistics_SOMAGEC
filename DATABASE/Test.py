...
home = ImageTk.PhotoImage(Image.open('DATABASE/Assets/image/personnel.png').resize((40,40),Image.ANTIALIAS))
settings = ImageTk.PhotoImage(Image.open('DATABASE/Assets/image/personnel.png').resize((40,40),Image.ANTIALIAS))
ring = ImageTk.PhotoImage(Image.open('DATABASE/Assets/image/personnel.png').resize((40,40),Image.ANTIALIAS))
