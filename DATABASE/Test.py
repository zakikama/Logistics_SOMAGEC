...
class Tableau_Donnees(tk.Frame):
    def __init__(self, parent):
        ...
        button_refresh = tk.Button(tab1, text="refresh", font=ButtonFont, highlightbackground="#2d5b6b",command=lambda:self.refresh_table(self.parents))
        ...
        button_Supprimer.pack(padx=10, pady=10, side=tk.LEFT)
        button_refresh = tk.Button(tab2, text="refresh", highlightbackground="#2d5b6b", font=ButtonFont)
        button_refresh.pack(padx=10, pady=10, side=tk.RIGHT)
        ...
        button_Supprimer.pack(padx=10, pady=10, side=tk.LEFT)
        button_refresh = tk.Button(tab3, text="refresh", font=ButtonFont, highlightbackground="#2d5b6b",command=lambda:self.refresh_table(self.parents))
        button_refresh.pack(padx=10, pady=10, side=tk.RIGHT)
        ...
        button_Supprimer.pack(padx=10, pady=10, side=tk.LEFT)
        button_refresh = tk.Button(tab4, text="refresh", font=ButtonFont, highlightbackground="#2d5b6b",command=lambda:self.refresh_table(self.parents))
        button_refresh.pack(padx=10, pady=10, side=tk.RIGHT)
        ...
        button_Supprimer.pack(padx=10, pady=10, side=tk.LEFT)
        button_refresh = tk.Button(tab5, text="refresh", font=ButtonFont, highlightbackground="#2d5b6b",command=lambda:self.refresh_table(self.parents))
        button_refresh.pack(padx=10, pady=10, side=tk.RIGHT)
