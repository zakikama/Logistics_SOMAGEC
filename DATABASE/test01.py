...
def motion(eventorigin):
            ...
            x = eventorigin.x
            y = eventorigin.y
            if ((14 <= x <= 104 and 32 <= y <= 69) ):
                my_gui.refresh_Dashboard(bottom_box)
                app.show_frame("HomePage")
                
            elif ((14 <= x <= 122 and 180 <= y <= 218) ):
                app.show_frame("LogisticsPage")
            elif ((14 <= x <= 132 and 332 <= y <= 368) ):
                app.show_frame("TraitmentPage")
def Formulaire_Personnels():
    root = tk.Toplevel(app)
    root.title("Ajouter personnels")
    image = Image.open(
        'DATABASE/Assets/image/Form.png')
...
def Formulaire_MPersonnel(Personelle):
    ...
    def edit():
        ...
        modifier_chauf_grais(fonctionPersonnel_entry.get(),
                             MatriculePersonnel_entry.get())
...
def Figure_Globale():
    ...
    plot.set_xticklabels(xticks, fontdict=None, minor=False,color="white")
...
class HomePage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.photo_SideBar= ImageTk.PhotoImage(Image.open("DATABASE/Assets/image/icon.png").resize((180, 180)))
        self.Home_A=ImageTk.PhotoImage(Image.open("DATABASE/Assets/image/Home_A.png").resize((100, 100))) 
        # self.Home_D=ImageTk.PhotoImage(Image.open("DATABASE/Assets/image/Home_D.png").resize((100, 100))) 
        # self.Logist_A=ImageTk.PhotoImage(Image.open("DATABASE/Assets/image/logis_A.png").resize((100, 100))) 
        self.Logist_D=ImageTk.PhotoImage(Image.open("DATABASE/Assets/image/Logis_D.png").resize((100, 100))) 
        # self.Trait_A=ImageTk.PhotoImage(Image.open("DATABASE/Assets/image/Trait_A.png").resize((100, 100))) 
        self.Trait_D=ImageTk.PhotoImage(Image.open("DATABASE/Assets/image/Trait_D.png").resize((100, 100))) 
        canvas = Canvas(
                    container,
                    width=135,
                    height=1000,
        ...
        canvas.create_image(-22,590, anchor = 'nw', image=self.photo_SideBar)
        canvas.create_image(-15,0, anchor = 'nw', image= self.Home_A)
        canvas.create_text(
                    85,
                    55,
                    text="HOME",
        ...
        canvas.create_image(-15,150, anchor = 'nw', image= self.Logist_D)
        canvas.create_text(
                    97,
                    203,
                    text="LOGISTICS",
        ...
        canvas.create_image(-17,300, anchor = 'nw', image= self.Trait_D)
        canvas.create_text(
                    97,
                    351,
                    text="TRAITEMENT",
...
class LogisticsPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        canvas.create_image(-22,590, anchor = 'nw', image=self.photo_SideBar)
        canvas.create_image(-15,0, anchor = 'nw', image= self.Home_D)
        canvas.create_text(
                    85,
                    55,
                    text="HOME",
        ...
        canvas.create_image(-15,150, anchor = 'nw', image= self.Logist_A)
        canvas.create_text(
                    97,
                    203,
                    text="LOGISTICS",
...
class TraitmentPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        image = Image.open(
            "DATABASE/Assets/image/logo02.jpg")
        ...
        NatureTrD = StringVar()
        OPTIONSC = get_matricule_Chauffeurs_Graisseurs_statut("Libre")
        OPTIONSG = get_matricule_Chauffeurs_Graisseurs_statut("Libre")
        OPTIONSV = get_matricule_Parc_Vehicule_statut("Libre")
        OPTIONSR = get_matricule_Parc_Remorque_statut("Libre")
        OPTIONS_CHANTIER = get_intitule_Chantier()
        OPTIONSE = get_designation_Parc_Engin_statut("Libre")
...
class StartPage(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        image = Image.open(
            "DATABASE/Assets/image/LoginBackground.png")
